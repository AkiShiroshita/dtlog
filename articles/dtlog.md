...
#> fwrite: wrote 19 rows and 4 columns to 'file1b64140863b8.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1b64140863b8.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpMfhXME/file1b642edc44b0.txt'
```
...
# dtlog transcript, started 2026-08-22 09:44:08
...
# dtlog transcript, ended 2026-08-22 09:44:08 (3 operations)
```
