...
#> fwrite: wrote 19 rows and 4 columns to 'file1a9fe68e9bd.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1a9fe68e9bd.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpODxdtc/file1a9f4ebb8cb9.txt'
```
...
# dtlog transcript, started 2026-09-16 00:29:18
...
# dtlog transcript, ended 2026-09-16 00:29:18 (3 operations)
```
