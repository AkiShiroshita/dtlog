...
#> fwrite: wrote 19 rows and 4 columns to 'file1ae655eda68e.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1ae655eda68e.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpvCAHy2/file1ae668afa6c0.txt'
```
...
# dtlog transcript, started 2026-09-16 02:08:48
# R version 4.6.1 (2026-06-24), data.table 1.18.6.1, dtlog 0.2.0
> merged[!is.na(crp)]
filter: removed 5 rows (10%), 46 rows remaining
...
# dtlog transcript, ended 2026-09-16 02:08:48 (3 operations)
```
