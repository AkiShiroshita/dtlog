...
#>     <num> <num> <num> <num> <num> <num> <num> <num> <num> <num> <num>   <num>
dt_log_end()
#> dt_log: wrote 2 operations to '/tmp/Rtmpv7JBN0/file18e970fac705.txt'
cat(readLines(path), sep = "\n")
#> # dtlog transcript, started 2026-09-16 00:04:46
...
#> 
#> # dtlog transcript, ended 2026-09-16 00:04:46 (2 operations)
```
