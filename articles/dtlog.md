...
#> fwrite: wrote 19 rows and 4 columns to 'file1a123bc06847.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1a123bc06847.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpJ23iRI/file1a121067603.txt'
```
...
# dtlog transcript, started 2026-09-16 02:37:21
...
# dtlog transcript, ended 2026-09-16 02:37:21 (3 operations)
```
