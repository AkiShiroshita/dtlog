...
#> fwrite: wrote 19 rows and 4 columns to 'file1a721de5791.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1a721de5791.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmplX1XHA/file1a7270aec19b.txt'
```
...
# dtlog transcript, started 2026-09-16 00:04:49
...
# dtlog transcript, ended 2026-09-16 00:04:49 (3 operations)
```
