...
#' visibility all behave exactly as they do in `data.table`, and every argument
#' is evaluated exactly as often as `data.table` evaluates it, so an argument
#' written as an expression with a side effect still runs only once.
#'
#' @section Options:
#' \describe{
