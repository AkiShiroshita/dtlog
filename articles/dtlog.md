...
#> fwrite: wrote 19 rows and 4 columns to 'file1ad9ab1ce6b.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1ad9ab1ce6b.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/Rtmpmm7zmC/file1ad97b3b0fb0.txt'
```
...
# dtlog transcript, started 2026-08-22 11:06:40
...
# dtlog transcript, ended 2026-08-22 11:06:40 (3 operations)
```
