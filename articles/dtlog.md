...
#> fwrite: wrote 19 rows and 4 columns to 'file1a8110622452.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1a8110622452.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/Rtmpt5qxHd/file1a81e7b4a2f.txt'
```
...
# dtlog transcript, started 2026-08-22 10:36:06
...
# dtlog transcript, ended 2026-08-22 10:36:06 (3 operations)
```
