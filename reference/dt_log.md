...
#>     <num> <num> <num> <num> <num> <num> <num> <num> <num> <num> <num>   <num>
dt_log_end()
#> dt_log: wrote 2 operations to '/tmp/RtmpOHU5AU/file19126aaedaaf.txt'
cat(readLines(path), sep = "\n")
#> # dtlog transcript, started 2026-09-16 00:51:47
...
#> 
#> # dtlog transcript, ended 2026-09-16 00:51:47 (2 operations)
```
