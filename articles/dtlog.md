...
#> fwrite: wrote 19 rows and 4 columns to 'file1a9e3c011ddf.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1a9e3c011ddf.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpTCludK/file1a9e65884fef.txt'
```
...
# dtlog transcript, started 2026-09-05 22:15:33
...
# dtlog transcript, ended 2026-09-05 22:15:33 (3 operations)
```
