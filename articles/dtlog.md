...
#> fwrite: wrote 19 rows and 4 columns to 'file19e9457235a0.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file19e9457235a0.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpYVQ5pp/file19e9276ac80.txt'
```
...
# dtlog transcript, started 2026-09-16 00:27:27
...
# dtlog transcript, ended 2026-09-16 00:27:27 (3 operations)
```
