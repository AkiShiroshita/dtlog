...
#>     <num> <num> <num> <num> <num> <num> <num> <num> <num> <num> <num>   <num>
dt_log_end()
#> dt_log: wrote 2 operations to '/tmp/RtmpAyHdv1/file193f234060fd.txt'
cat(readLines(path), sep = "\n")
#> # dtlog transcript, started 2026-08-24 14:06:57
...
#> 
#> # dtlog transcript, ended 2026-08-24 14:06:57 (2 operations)
```
