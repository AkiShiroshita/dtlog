...
#>     <num> <num> <num> <num> <num> <num> <num> <num> <num> <num> <num>   <num>
dt_log_end()
#> dt_log: wrote 2 operations to '/tmp/RtmpYfgnHY/file19362a47959b.txt'
cat(readLines(path), sep = "\n")
#> # dtlog transcript, started 2026-08-22 11:19:36
...
#> 
#> # dtlog transcript, ended 2026-08-22 11:19:36 (2 operations)
```
