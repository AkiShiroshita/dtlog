...
#> fwrite: wrote 19 rows and 4 columns to 'file1aae31deb679.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1aae31deb679.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpYzeNpL/file1aae2370a0bd.txt'
```
...
# dtlog transcript, started 2026-09-05 21:31:29
...
# dtlog transcript, ended 2026-09-05 21:31:29 (3 operations)
```
