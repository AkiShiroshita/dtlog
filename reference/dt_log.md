...
#>     <num> <num> <num> <num> <num> <num> <num> <num> <num> <num> <num>   <num>
dt_log_end()
#> dt_log: wrote 2 operations to '/tmp/RtmpvuINX2/file19da4e96031d.txt'
cat(readLines(path), sep = "\n")
#> # dtlog transcript, started 2026-08-22 09:44:04
...
#> 
#> # dtlog transcript, ended 2026-08-22 09:44:04 (2 operations)
```
