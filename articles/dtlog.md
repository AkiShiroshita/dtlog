...
#> fwrite: wrote 19 rows and 4 columns to 'file1b4036371221.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1b4036371221.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/Rtmp3AwCLe/file1b406eef4955.txt'
```
...
# dtlog transcript, started 2026-08-24 14:22:42
...
# dtlog transcript, ended 2026-08-24 14:22:42 (3 operations)
```
