...
#> fwrite: wrote 19 rows and 4 columns to 'file1b3b464f777c.csv'
patients <- fread(path)
#> fread: read 19 rows and 4 columns from 'file1b3b464f777c.csv'
```
...
dt_log_end()
#> dt_log: wrote 3 operations to '/tmp/RtmpUZHCjm/file1b3b78da8233.txt'
```
...
# dtlog transcript, started 2026-08-24 15:20:46
...
# dtlog transcript, ended 2026-08-24 15:20:46 (3 operations)
```
